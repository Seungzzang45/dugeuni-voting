...
const battingRankings = [
  ...
  { rank: 2, name: '신승우', avg: 0.588 },
  { rank: 3, name: '신세휘', avg: 0.556 },
  { rank: 4, name: '안황기', avg: 0.545 },
  { rank: 5, name: '이호겸', avg: 0.500 },
  { rank: 5, name: '양성철', avg: 0.500 },
  { rank: 7, name: '전계훈', avg: 0.476 },
  { rank: 8, name: '홍경택', avg: 0.467 },
  { rank: 9, name: '윤민환', avg: 0.444 },
  { rank: 10, name: '나인철', avg: 0.385 },
  { rank: 11, name: '김상훈', avg: 0.357 },
  { rank: 12, name: '엄민영', avg: 0.333 },
  { rank: 12, name: '이광석', avg: 0.333 },
  { rank: 14, name: '문대웅', avg: 0.316 },
  { rank: 15, name: '김학래', avg: 0.250 },
  { rank: 15, name: '김현진', avg: 0.250 },
  { rank: 17, name: '이원중', avg: 0.000 },
]

// 투수 순위 (다승, 방어율)
const pitchingRankings = [
  { rank: 1, name: '이광석', wins: 2, era: 3.63 },
  ...
  { rank: 6, name: '신세휘', wins: 0, era: 58.80 },
]
